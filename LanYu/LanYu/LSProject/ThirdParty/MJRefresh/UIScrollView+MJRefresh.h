...
//@property (strong, nonatomic) MJRefreshHeader *header MJRefreshDeprecated("使用header");
/** 上拉刷新控件 */
@property (strong, nonatomic) MJRefreshFooter *footer;
//@property (strong, nonatomic) MJRefreshFooter *footer MJRefreshDeprecated("使用footer");
